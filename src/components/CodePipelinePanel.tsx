...
export default function CodePipelinePanel() {
  ...
  const handleProposeChange = async () => {
    ...
    const stepLogs = [
      ...
      `[EXEC-TEST] Initiating Step 4: Bootstrapping dynamic run simulation with 500,000 tick market history playback...`,
      `[EXEC-TEST] Success: Execution playback completed cleanly. Total reward accumulated: +2.15e+07. Leaked: 0 bytes.`,
